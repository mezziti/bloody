...
const Home = ({ auth, requests, cities }) => {
  ...
  requests = city ? requests.filter((request) => request.city.id === city) : requests;
  requests = blood_type ? requests.filter((request) => request.blood_type === blood_type) : requests;
  return (
    <Guest user={user}>
              ...
              <div>
                {requests.length > 0 ? (
                            ...
                            <div className="flex flex-col justify-between p-4 leading-normal">
                              ...
                              <div className="flex-row sm:flex">
                                <h5 className="mb-2 text-md font-medium tracking-tight text-gray-900 dark:text-white">
                                  Last Donation :<br />
                                  {request.last_donation_date.split(" ")[0]}
                                </h5>
                  ...
                  <div className="flex items-center justify-center h-64 col-span-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                    <p className="text-gray-500 dark:text-gray-400">
                      No requests found{city ? ` for the selected city` : ""}.
                    </p>
                  </div>
                )}
              </div>
