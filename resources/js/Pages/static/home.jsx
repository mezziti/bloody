                    ...
                    <div className="grid md:grid-cols-2 md:gap-10 lg:gap-16">
                        <div className="flex flex-col justify-center space-y-4">
                            ...
                            <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                                The best place to deploy your frontend apps.
                                Instantly preview frontend code changes in the
                                cloud. Zero configuration.
                            </p>
                        </div>
                        <div className="w-full aspect-video overflow-hidden rounded-xl ring-1 ring-gray-200 ring-opacity-10 md:aspect-none">
            ...
            {/* <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                        Join us in our blood donation drive and be a hero! Every
                        drop of blood you donate has the power to save lives.
                        Let’s come together, roll up our sleeves, and give the
                        gift of life. Remember, it’s not just blood; it’s hope,
                        compassion, and a chance for someone to see another
                        sunrise. Be part of this life-saving mission and spread
                        the word. Together, we can make a difference! 🩸💪
                    </p>
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        <Link
                            href="#"
                            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900"
                        >
                            Learn more
                            <svg
                ...
                <div className="grid max-w-screen-xl px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:pb-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="max-w-2xl mb-6 font-normal text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            ...
                            give the gift of life. Be part of this
