...
class DriveController extends Controller
{
  ...
  public function index()
  {
    return Inertia::render('drives/index', [
      'drives' => Drive::where('blood_bank_id', auth()->id())->with('city')->orderBy('created_at', 'desc')->paginate(10),
  ...
  public function store(Request $request)
  {
    ...
    $validatedData['blood_bank_id'] = auth()->id();
  ...
  {
    if ($drive->blood_bank_id != auth()->id()) {
